    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="/storage/images/users/{{ Auth::user()->profpho }}" style="width:32px; height:32px; position:absolute; top:10px; left:10px; border-radius:50%" class="user-image" alt="User Image">
            </div>
